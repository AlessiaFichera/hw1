      ...
      <header>
        <nav class="nav1">
          ...
          <div class="overlay5">
            ...
            <button  id="login"><img id="lock" src="immagini/lock.png"/><a href="login.php"><b>ACCEDI</b><a></button>
        </nav>
      </header>
      ...
      <nav class="mobile-menu">
          ...
          <div class="contenuto">
            ...
            <a href="spotify.php"><b>Spotify</b></a>
              ...
              <a href="login.php"><b>Accedi</b><img id="logout" src="immagini/lock-bianco.png"/></a>
            </div>
        </nav>
  </body>
</html>
