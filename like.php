    ...
    <header>
        <nav class="nav1">
          ...
          <div class="overlay5">
            ...
            <a href="logout.php" class="intestazione"><img id="account" src="immagini/account.png"/></a>
      ...
      <div class="nuvole"></div>
        ...
        <div class="like"><a id="preferiti"> Le mie attrazioni preferite:<br></a> 
        <a id="attrazioni">Themepark</a></div>

    <section id="galleria_like">

       
    </section>
    <div id="acquapark"><a>Acquapark</a></div>
    <section id="galleria_like_acquapark">
