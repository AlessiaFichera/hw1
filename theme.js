...
const images = [
    'immagini/44gatti.jpg',
    'immagini/immaginethem.jpg'
  ];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  linkElements.forEach(function(linkElement) {
    linkElement.addEventListener('mouseover', function() {
      ...
      nuvoletteBanner.style.background = 'rgba(255, 0, 255, 0.5)';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function toggleImmagine(event) {
    ...
    if (event.currentTarget.src.includes('cuore_vuoto_viola.png')) {
      console.log("like aggiunto" + id);
      event.currentTarget.src = 'immagini/cuore_pieno_viola.png';
      ...
      event.currentTarget.src = 'immagini/cuore_vuoto_viola.png';
    ...
    fetch("id_like.php")
      ...
      .then(function(data) {
        data.forEach(function(item) {
          ...
          if (image) {
            image.src = 'immagini/cuore_pieno_viola.png';
          }
        });
      });
  }
