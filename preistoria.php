...
<html>
    <head>
      ...
      <title>Etnaland - Parco della Preistoria </title>
      <link rel="icon" href="immagini/download.png" type="image/png">
      <link rel="stylesheet" href="preistoria.css" />
      <script src="preistoria.js" defer></script>
    ...
    <body>
      ...
      <nav class="nav2">
        ...
        <div class="nuvole"> <img src="immagini/parco-preistoria_logo.png"/></div>
        <div class="box-verde">
            <div class="box2"><p class="esplora"><B>Esplora il <br> Parco della Preistoria</B><br></p> <img id="ciclopino" src="immagini/ciclopino-mongolfiera.png" />
              <img id="ciclopina" src="immagini/ciclopina-liana.png" /> </div>
            <nav class="nav_preistoria">
           <a class="Paleozoico" id="Paleozoico"><b>Paleozoico</b><br>da -520 a -230 <br> milioni di anni fa </a>
           <a class="Mesozoico" id="Mesozoico"><b>Mesozoico</b><br>da -230 a -60 <br> milioni di anni fa </a>
            <a class="Cenozoico" id="Cenozoico"><b>Cenozoico</b><br>da -65 a -2 <br> milioni di anni fa </a>
         <a class="Neozoico" id="Neozoico"><b>Neozoico</b><br>da -2 a oggi <br> milioni di anni fa </a>
       </nav>
      <div class="immagini"><img  id="banner1"src="immagini/preistoria_banner-visit-preistoria_it.png"><img id="banner2"src="immagini/preistoria_banner-ingresso_it.png"></div>
      <div class="immagini"><img id="banner3"src="immagini/preistoria_banner-paper-toys_it.png"></div>
